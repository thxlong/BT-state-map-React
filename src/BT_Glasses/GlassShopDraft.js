...
export default class GlassShopDraft extends Component {
  arrProduct = [
    {
      id: 1,
      price: 30,
    ...
    return (
      ...
      >
        ...
        <div className="container-fluid row">
          <div className="col-4">
            <div>
              <div className="d-flex">
                <img src="./img/model.jpg" alt="./img/model.jpg" />
                <div
          ...
          <div className="col-4">
            <img src="./img/model.jpg" alt="./img/v1.png" />
          </div>
        </div>
